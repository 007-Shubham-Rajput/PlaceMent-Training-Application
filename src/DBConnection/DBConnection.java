...
{    
   final static String DB_URL="jdbc:oracle:thin:@OracleDB2_high?TNS_ADMIN=D:\\Wallet_OracleDB2";
   final static String DB_USER_NAME="ADMIN";
   final static String DB_PASS="Neelesh@1210";
