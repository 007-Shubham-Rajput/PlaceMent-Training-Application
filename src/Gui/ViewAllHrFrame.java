 ...
 * @author Neel_Esh
 */
public class ViewAllHrFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllHrFrame
     */
    DefaultTableModel model;
    public ViewAllHrFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllHrFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllHrFrame().setVisible(true);
            }
        });
    }
