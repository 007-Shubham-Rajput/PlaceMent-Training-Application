 ...
 * @author Neel_Esh
 */
public class AddNewJobFrame extends javax.swing.JFrame {

    public AddNewJobFrame() {
        initComponents();
        this.setLocationRelativeTo(null);
        nameLbl.setText(GeneralDetails.name);
        reloadData();
    ...
    void reloadData()     
    {
         try
        {
            jobIdLbl.setText("Job-"+JobTableDao.getJobId());
            companyNameTxt.setText(HrTableDao.getCompanyNameById(GeneralDetails.id));
        }
        catch(SQLException ex)
        {
            JOptionPane.showMessageDialog(null,"Error while loading the Job-id","Error",JOptionPane.INFORMATION_MESSAGE);
            ex.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jobTitleTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 435, 310, 30));
        ...
        jPanel1.add(companyNameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(415, 435, 310, 30));
        ...
        addJobBtn.setBackground(new java.awt.Color(173, 192, 234));
        ...
        jPanel1.add(addJobBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 670, 250, 30));
        ...
        jPanel1.add(jobIdLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 150, 30));
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        new JobOptionFrame().setVisible(true);
        this.dispose();
    ...
    private void addJobBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJobBtnActionPerformed
        ...
        if(validateInputs())
        {
            ...
            job.setCompanyName(companyNameTxt.getText().trim());
            ...
            try
            {
                if(JobTableDao.addNewJob(job))
                {
                    JOptionPane.showMessageDialog(null,"Job Added SuccessFully","Done",JOptionPane.INFORMATION_MESSAGE);
                    reloadData();
                    jobTitleTxt.setText("");
                    skill1Txt.setText("");
                    skill2Txt.setText("");
                ...
                {
                    JOptionPane.showMessageDialog(null,"Something went wrong\nwhile adding job","Error",JOptionPane.WARNING_MESSAGE);
                    return;
                }
            }
            catch(SQLException ex)
            {
                JOptionPane.showMessageDialog(null,"Error While adding a job","DB_Error",JOptionPane.INFORMATION_MESSAGE);
                ex.printStackTrace();
                return;
            }   
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewJobFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewJobFrame().setVisible(true);
            }
        });
    }
