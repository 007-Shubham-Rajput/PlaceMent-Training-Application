 ...
 * @author Neel_Esh
 */
public class AdminHrModule extends javax.swing.JFrame {

    /**
     * Creates new form adminHrModule
     */
    public AdminHrModule() {
        initComponents();
    ...
    private void modHrBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modHrBtnActionPerformed
        // TODO add your handling code here:
        new ModifyHrFrame().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminHrModule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
