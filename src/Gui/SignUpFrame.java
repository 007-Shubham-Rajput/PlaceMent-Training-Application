...
public class SignUpFrame extends javax.swing.JFrame {
    ...
    void reloadId()
    {
         try
        {
            pIdLbl.setText("P-"+Dao.ParticipantsTableDao.getParticipantsId());
        }
    ...
    private void createAccBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAccBtnActionPerformed
        ...
        if(validateInputs())
        {
            ...
            pt.setPhone(Long.parseLong(txtPhone.getText().trim()));
            ...
            if(ParticipantsTableDao.addNewParticipants(pt))
            {
