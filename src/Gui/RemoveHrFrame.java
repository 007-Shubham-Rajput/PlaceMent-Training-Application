...
import Dao.QualifiedParticipantsDao;
 ...
 * @author Neel_Esh
 */
public class RemoveHrFrame extends javax.swing.JFrame {

    /**
     * Creates new form RemoveHrFrame
     */
    DefaultTableModel model;
    public RemoveHrFrame() {
        initComponents();
        nameLbl.setText(GeneralDetails.getName());
    ...
    private void initComponents() {
        ...
        removeHrBtn = new javax.swing.JButton();
        ...
        removeHrBtn.setBackground(new java.awt.Color(173, 192, 234));
        removeHrBtn.setText("Remove HR");
        removeHrBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                removeHrBtnActionPerformed(evt);
            }
        });
        jPanel1.add(removeHrBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 670, 250, 30));
        ...
        AllHrTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, "Neelesh", "8871414187", "2"},
        ...
        AllHrTbl.setColumnSelectionAllowed(true);
        AllHrTbl.setShowGrid(true);
        AllHrTbl.getTableHeader().setReorderingAllowed(false);
        jScrollPane2.setViewportView(AllHrTbl);
        AllHrTbl.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        if (AllHrTbl.getColumnModel().getColumnCount() > 0) {
            AllHrTbl.getColumnModel().getColumn(0).setResizable(false);
            AllHrTbl.getColumnModel().getColumn(1).setResizable(false);
            AllHrTbl.getColumnModel().getColumn(2).setResizable(false);
            AllHrTbl.getColumnModel().getColumn(3).setResizable(false);
            AllHrTbl.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    private void removeHrBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeHrBtnActionPerformed
        // TODO add your handling code here:
        int row=AllHrTbl.getSelectedRow();
        if(row>-1)
        {
            int res=JOptionPane.showConfirmDialog(null,"Are you sure want to delete "+AllHrTbl.getValueAt(row,0),"Confirmatation",JOptionPane.INFORMATION_MESSAGE);
            if(res==JOptionPane.OK_OPTION)
            {   
                try
                {
                    HrPojo hr=new HrPojo();
                    hr.setHrId((String)AllHrTbl.getValueAt(row,0));
                    hr.setUserId((String)AllHrTbl.getValueAt(row,1));
                    
                    if(HrTableDao.removeHr(hr))
                       JOptionPane.showMessageDialog(null,"Hr Removed Successfully","SuccessFully",JOptionPane.INFORMATION_MESSAGE);
                    model.setRowCount(0);
    ...
    }//GEN-LAST:event_removeHrBtnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveHrFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveHrFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton removeHrBtn;
