 ...
 * @author Neel_Esh
 */
public class ParticipantsAppliedJobFrame extends javax.swing.JFrame {

    /** Creates new form ParticipantsAppliedJobFrame */
    public ParticipantsAppliedJobFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParticipantsAppliedJobFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParticipantsAppliedJobFrame().setVisible(true);
            }
        });
    }
