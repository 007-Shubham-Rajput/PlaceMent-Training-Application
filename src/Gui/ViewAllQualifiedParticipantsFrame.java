 ...
 * @author Neel_Esh
 */
public class ViewAllQualifiedParticipantsFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllQualifiedParticipantsFrame
     */
    public ViewAllQualifiedParticipantsFrame() {
        initComponents();
        GeneralDetails.setType("Admin");
        nameLbl.setText(GeneralDetails.getName());
        try
        {
            if(GeneralDetails.getType().equals("Admin"))
            {
                insertData(QualifiedParticipantsDao.allQualifiedParticipantsIdByStatus1());
                return;
            }
            else
            {
                ResultSet rs1;
                ResultSet rs=QualifiedParticipantsDao.allQualifiedParticipantsIdByStatus_CmpName(HrTableDao.getCompanyNameById("Hr-103"));
                int flag=0;
                for(int i=0;rs.next();i++)
                {   
                    flag=flag+1;
                    rs1=ParticipantsTableDao.viewParticipantsById(rs.getString(i+1));
                    if(rs1.next())
                    {   
                        for(int j=0;j<4;j++)
                        {
                            if(j<3)
                                allParticipantsTable.setValueAt(rs1.getString(j+1),i,j);
                            else
                                allParticipantsTable.setValueAt(rs1.getString(j+2),i,j);
                        }
                    }
                ...
                if(flag==0)
                {
                    JOptionPane.showMessageDialog(null,"No record found","SomeThing Went Wrong ",JOptionPane.WARNING_MESSAGE);
                }
            }
        }
            ...
            {   
                ...
                for(int j=0;j<4;j++)
                {
                    if(j<3)
                        ...
                        allParticipantsTable.setValueAt(rs.getString(j+2),i,j);
                }
            }
            if(flag==0)
            {
    ...
    private void initComponents() {
        ...
        jPanel1.add(nameLbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 280, 30));
        ...
        allParticipantsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Neelesh", "8871414187", "job-101 , job 102", "2"},
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Participants Id", "Name", "Mail ", "Description"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllQualifiedParticipantsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllQualifiedParticipantsFrame().setVisible(true);
            }
        });
    }
