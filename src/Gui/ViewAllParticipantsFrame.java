 ...
 * @author Neel_Esh
 */
public class ViewAllParticipantsFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllParticipantsFrame
     */
    public ViewAllParticipantsFrame() {
        initComponents();
        ...
        try
        {
            ...
            {
                insertData(ParticipantsTableDao.viewAllParticipantsAdmin());
                return;
            }
            else
            {
                ResultSet rs1;
                ResultSet rs=QualifiedParticipantsDao.allParticipantsIdByCompanyName(HrTableDao.getCompanyNameById(GeneralDetails.getId()));
                int flag=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(nameLbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 140, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllParticipantsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllParticipantsFrame().setVisible(true);
            }
        });
    }
