 ...
 * @author Neel_Esh
 */
public class RemoveJobFrame extends javax.swing.JFrame {

    /**
     * Creates new form RemoveJobFrame
     */
    DefaultTableModel model;
    public RemoveJobFrame() {
        initComponents();
    ...
    void insertData()
    {
        try
        {
            ResultSet rs=JobTableDao.getAllJobByCompanyName(HrTableDao.getCompanyNameById(GeneralDetails.id.trim()));
            int flag=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(removeJobBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 670, 250, 30));
        ...
        AllJobTbl.setCellSelectionEnabled(false);
        AllJobTbl.setRowSelectionAllowed(true);
    ...
    private void removeJobBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeJobBtnActionPerformed
        ...
        if(row!=-1)
        {
            int ans=JOptionPane.showConfirmDialog(null,"Do you really want to delete job ?","Confirmatation",JOptionPane.INFORMATION_MESSAGE);
            if(ans==JOptionPane.OK_OPTION)
            {
                try
                {   
                    if(JobTableDao.removeJobByJobId((String)AllJobTbl.getValueAt(row,0).toString().trim()))
                    {
                        JOptionPane.showMessageDialog(null,"Job deleted successFully","Done",JOptionPane.INFORMATION_MESSAGE);
                        model.setRowCount(0);
                ...
                {
                    JOptionPane.showMessageDialog(null,"DB-Error While deleting a job","Error",JOptionPane.INFORMATION_MESSAGE);
                    ex.printStackTrace();
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveJobFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveJobFrame().setVisible(true);
            }
        });
    }
