 ...
 * @author Neel_Esh
 */
public class ModifyHrFrame extends javax.swing.JFrame {

    /**
     * Creates new form ModifyHrFrame
     */
    UserPojo user;
    public ModifyHrFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        addNewHrBtn.setText("Modify Changes of HR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyHrFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
