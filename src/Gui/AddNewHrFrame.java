 ...
 * @author Neel_Esh
 */
public class AddNewHrFrame extends javax.swing.JFrame {

    /**
     * Creates new form AddNewHrFrame
     */
    public AddNewHrFrame() {
        initComponents();
    ...
    void loadId()
    {
        try
        {
            HrIdLbl.setText("Hr-"+Dao.HrTableDao.getHrId());
        }
    ...
    private void initComponents() {
        ...
        professionJList = new javax.swing.JComboBox<>();
        ...
        HrIdLbl = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        CmpNameTxt = new javax.swing.JTextField();
        ...
        professionJList.setBackground(new java.awt.Color(173, 192, 234));
        professionJList.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose Profession", "Developer", "Technical", "Apptitude", "Digital Marketing" }));
        jPanel1.add(professionJList, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 485, 300, 30));
        ...
        jPanel1.add(CnfPwdTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 565, 300, 30));
        ...
        jPanel1.add(PwdTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 565, 310, 30));
        ...
        HrIdLbl.setFont(new java.awt.Font("Noteworthy", 1, 18)); // NOI18N
        jPanel1.add(HrIdLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 315, 120, 30));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 345, 180, 10));

        CmpNameTxt.setBackground(new java.awt.Color(243, 246, 254));
        CmpNameTxt.setFont(new java.awt.Font("Heiti TC", 0, 18)); // NOI18N
        CmpNameTxt.setBorder(null);
        CmpNameTxt.setOpaque(false);
        jPanel1.add(CmpNameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 325, 180, 20));
    ...
    private void addNewHrBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewHrBtnActionPerformed
        ...
        {   
            ...
            hr.setHrId(HrIdLbl.getText().trim());
            hr.setName(txtName.getText().trim());
            hr.setUserId(txtMail.getText().toUpperCase().trim());
            hr.setPhone(Long.parseLong(txtMob.getText().trim()));
            hr.setPassword(PwdTxt.getText().trim());
            hr.setProfession(professionJList.getSelectedItem().toString().trim());
            hr.setCompanyName(CmpNameTxt.getText().trim());
            hr.setType("Hr");
            try
            {
                if(Dao.HrTableDao.addNewHr(hr))
                {
                    ...
                    CnfPwdTxt.setText("");
                    CmpNameTxt.setText("");
                    professionJList.setSelectedIndex(0);
                    loadId();
                    return;
                }  
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewHrFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewHrFrame().setVisible(true);
            }
        });
    }
    private boolean validateInputs()
    {
        if(txtName.getText().equals("") || txtMail.getText().equals("") || txtMob.getText().equals("") || PwdTxt.getText().equals("") || CnfPwdTxt.getText().equals("") || CmpNameTxt.getText().equals("") || professionJList.getSelectedIndex()==0)
        {
            if(pwdInputs())
            {
                return true;
    ...
    private javax.swing.JComboBox<String> professionJList;
